...
REACT_PROJECT_ROOT = os.path.join(BASE_DIR, "..", "travel-guide", "web")
REACT_SRC_DATA = os.path.join(REACT_PROJECT_ROOT, "src", "data", "locations.json")  # Updated to JSON
UPLOAD_FOLDER = os.path.join(REACT_PROJECT_ROOT, "public", "uploads")
DEPTH_FOLDER = os.path.join(REACT_PROJECT_ROOT, "public", "depth_maps")
